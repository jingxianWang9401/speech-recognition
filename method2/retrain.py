  ...
  with tf.Session(graph=graph) as sess:
    ...
    for i in range(FLAGS.how_many_training_steps):
      ...
      if (i % FLAGS.eval_step_interval) == 0 or is_last_step:
        ...
        traintxt=str(train_accuracy)          # data是前面运行出的数据，先将其转为字符串才能写入
        with open('E:\speech_rocognition_demo\method2\\result\\train_nonoise.txt','a') as file_handle:
        ...
        with open('E:\speech_rocognition_demo\method2\\result\\validation_nonoise.txt','a') as file_handle:
...
if __name__ == '__main__':
  ...
  parser.add_argument(
      '--image_dir',
      type=str,
      default='E:/speech_rocognition_demo/method2/dataset/nonoise_images',
      help='Path to folders of labeled images.'
  )
  parser.add_argument(
      '--output_graph',
      type=str,
      default='E:/speech_rocognition_demo/method2/model_inception/output_graph.pb',
      help='Where to save the trained graph.'
  )
  parser.add_argument(
      '--intermediate_output_graphs_dir',
      type=str,
      default='E:/speech_rocognition_demo/method2/model_inception/intermediate_graph/',
  ...
  parser.add_argument(
      '--output_labels',
      type=str,
      default='E:/speech_rocognition_demo/method2/model_inception/output_labels.txt',
      help='Where to save the trained graph\'s labels.'
  )
  parser.add_argument(
      '--summaries_dir',
      type=str,
      default='E:/speech_rocognition_demo/method2/model_inception/retrain_logs',
  ...
  parser.add_argument(
      '--model_dir',
      type=str,
      default='E:/speech_rocognition_demo/method2/model_inception/imagenet',
      help="""\
  ...
  parser.add_argument(
      '--bottleneck_dir',
      type=str,
      default='E:/speech_rocognition_demo/method2/model_inception/bottleneck',
  ...
  parser.add_argument(
      '--saved_model_dir',
      type=str,
      default='E:/speech_rocognition_demo/method2/model_inception/saved_models/1/',
